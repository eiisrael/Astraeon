...
contracts={
    ...
    'src/chat-system-v4.js':['CHAT_LIMIT','64','exportChat','chat-char-counter','installSprintV43'],
    ...
    'src/editor-v2.js':['AUTO_EXPORT_KEY','showSaveFilePicker','downloadExport','validateDesign','validateAndRender','scheduleAutosave','linkExportFile','Salvar + exportar'],
