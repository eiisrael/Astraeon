...
select is((select amount from public.progression_operations where operation_id='72000000-0000-4000-8000-000000000101'),(-150)::bigint,'operation ledger records only a negative XP amount');
