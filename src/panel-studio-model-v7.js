...
const CATALOG=[
  {id:'start-main',name:'Menu principal',category:'Entrada',selector:'#startScreen .start-panel',titleSelector:'.logo',kickerSelector:'.eyebrow',bodySelector:'.lead',buttonSelector:'#newGameBtn',title:'ASTRAEON',kicker:'Ecos da Convergência',body:'Explore Astraeon em cinco climas e construa a sua jornada.',button:'Nova jornada',width:520,height:500},
  {id:'start-world',name:'Apresentação do mundo',category:'Entrada',selector:'#startScreen .world-panel',titleSelector:'.world-copy h3',kickerSelector:'.world-kicker',bodySelector:'.world-copy p',title:'Astraeon, continente vivo',kicker:'Mundo conectado',body:'Cidades, viajantes e histórias fazem parte do mundo.',width:590,height:500},
  ...
  {id:'hud-player',name:'HUD do personagem',category:'HUD',selector:'#hud .player-card',titleSelector:'#charText',kickerSelector:'#climateText',bodySelector:'.player-meta',title:'Viajante',kicker:'Convergência',body:'HP, MP, STAM e progressão de XP.',width:368,height:184,dynamicContent:true},
  ...
  {id:'online-chat',name:'Chat',category:'Online',selector:'.online-chat',titleSelector:'header b',bodySelector:'.online-chat-line.system span',title:'Chat',kicker:'Online',body:'Converse com viajantes conectados.',width:390,height:280,dynamicContent:true},
  ...
  {id:'npc-dialogue',name:'Diálogo com NPC',category:'Mundo',selector:'.npc-dialogue-card',titleSelector:'h2',bodySelector:'.npc-dialogue-messages',title:'Habitante de Astraeon',kicker:'Diálogo',body:'História e opções de conversa.',width:620,height:430,dynamicContent:true}
];
