...
function inspectorStyle(p){
  return section('Superfície','cores e gradiente',
    ...
    '<div class="pse-inline-buttons"><button class="pse-btn" type="button" data-preset="astraeon">Astraeon clássico</button><button class="pse-btn" type="button" data-preset="glass">Vidro astral</button><button class="pse-btn" type="button" data-preset="void">Vazio</button><button class="pse-btn" type="button" data-preset="lumen">Lúmen</button></div>'
  );
}
